...
class _OngoingOrderPageState extends State<OngoingOrderPage> {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return ListTile(
                ...
                onTap: () {
                  _showOrderDetails(context, orders[index].id, order['products']);
                },
              );
            },
          );
  ...
  void _showOrderDetails(BuildContext context, String invoiceId, List<dynamic> products) {
      ...
      builder: (context) {
        return Padding(
          ...
          child: Column(
            ...
            children: [
              Text("Invoice ID: $invoiceId", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
              ...
              ...products.map((product) {
                return ListTile(
                  ...
                  trailing: Text("\Rs. ${(product['price'] * product['quantity']).toStringAsFixed(2)}"),
                );
              }).toList(),
            ],
          ),
